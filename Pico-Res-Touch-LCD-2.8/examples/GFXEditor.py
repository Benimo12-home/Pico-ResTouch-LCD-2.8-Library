...
defpalette3 = {0:BLACK, 1:BLACK, 2:GREY, 3:WHITE, 4:0xFFFFFF, 5:0xBE5103, 6:0xCCCCCC, 7:0x12C675}
...
def testLayout():
    ...
    g.fillRectangle(16, 96, 128, 32, BLACK) #Exact coordinates to be used for spritesheet display box
...
def displaySpritesheet(path = "SystemSprites.txt", page = 1, palette = defpalette0):
            s = Spritesheet(ssd, path)
            s.drawSpritesheet(palette, ((page-1)*64), 16, 96)
testLayout()
